...
public class VehicleJourneyValidatorTests extends AbstractTestValidation {
	...
	public void verifyTest_3_VehicleJourney_1() throws Exception {
		...
		try {
			...
			CheckpointParameters checkPoint = new CheckpointParameters(L3_VehicleJourney_1, false, null, "2", null);
	...
	public void verifyTest_3_VehicleJourney_2() throws Exception {
		...
		try {
			...
			ValidateParameters parameters = (ValidateParameters) context.get(CONFIGURATION);
			Collection<CheckpointParameters> checkPoints = new ArrayList<>();
			CheckpointParameters checkPoint = new CheckpointParameters(L3_VehicleJourney_2, false, "11", "74", null);
			checkPoints.add(checkPoint);
			...
			CheckpointParameters modeCheckPoint = new CheckpointParameters(L3_VehicleJourney_2, false, "11", "72", null);
	...
	public void verifyTest_3_VehicleJourney_4() throws Exception {
		...
		try {
			...
			ValidateParameters parameters = (ValidateParameters) context.get(CONFIGURATION);
			Collection<CheckpointParameters> checkPoints = new ArrayList<>();
			CheckpointParameters checkPoint = new CheckpointParameters(L3_VehicleJourney_4, false, null,null, null);
			checkPoints.add(checkPoint);
	...
	public void verifyTest_3_VehicleJourney_5() throws Exception {
		...
		try {
			...
			ValidateParameters parameters = (ValidateParameters) context.get(CONFIGURATION);
			Collection<CheckpointParameters> checkPoints = new ArrayList<>();
			CheckpointParameters checkPoint = new CheckpointParameters(L3_VehicleJourney_5, false, null,null, null);
			checkPoints.add(checkPoint);
