...
public class VehicleJourneyValidator extends GenericValidator<VehicleJourney> implements CheckPointConstant {
	...
	private static final String[] codes = {L3_VehicleJourney_1,L3_VehicleJourney_2,L3_VehicleJourney_3,L3_VehicleJourney_4,L3_VehicleJourney_5};
	 ...
	 *  
 	 ...
 	 * <p>
 	 * <b>Message</b> : Sur la course {ObjectId}, la vitesse calculée {valeur} entre les arrêts {nomArrêt1} ({objectId}) et {nomArrêt2} ({objectId}) est supérieur au seuil toléré ({vitesseMax})<br>
	 *  Sur la course {ObjectId}, la vitesse calculée {valeur} entre les arrêts {nomArrêt1} ({objectId}) et {nomArrêt2} ({objectId}) est inférieure au seuil toléré ({vitesseMin})
 	 * <p>
 	 * <b>Criticité</b> :  warning
 	 * <p>
 	 * Note :  
	...
	/** 
 	 ...
 	 * <p>
 	 * <b>Message</b> : La course {objectId} a un horaire d'arrivé {hh:mm} supérieur à l'horaire de départ {hh:mm} à l'arrêt {nomArrêt} ({objectId}) <br>
	 *  La course {objectId} a un horaire de départ {hh:mm} à l'arrêt {nomArrêt} ({objectId}) supérieur à l'horaire d'arrivé {hh:mm} à l'arrêt suivant
 	 * <p>
 	 * <b>Criticité</b> :  error
 	 * <p>
 	 * Note :  
