...
public class TextFormater implements Formater {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see fr.certu.chouette.export.metadata.writer.Formater#format(fr.certu.
	 * chouette.export.metadata.model.Metadata.Period)
	 */
	@Override
	public String format(Period period) {
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
		return "du " + dateFormat.format(period.getStart().getTime()) + " au "
				+ dateFormat.format(period.getEnd().getTime());
	}
	 ...
	 * 
	 * @see fr.certu.chouette.export.metadata.writer.Formater#format(fr.certu.
	 * chouette.export.metadata.model.Metadata.Box)
	 */
	@Override
	public String format(Box box) {
		return " nord " + doubleFormat.format(box.getNorthLimit()) + ", sud " + doubleFormat.format(box.getSouthLimit())
				+ ", ouest " + doubleFormat.format(box.getWestLimit()) + ", est "
				+ doubleFormat.format(box.getEastLimit());
	}
	 ...
	 * 
	 * @see
	 * fr.certu.chouette.export.metadata.writer.Formater#format(java.util.List)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * fr.certu.chouette.export.metadata.writer.Formater#formatDate(java.util.
	 * Calendar)
	 */
	@Override
