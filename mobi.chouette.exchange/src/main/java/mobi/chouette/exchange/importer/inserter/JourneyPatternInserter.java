...
//		Monitor monitor = MonitorFactory.start(BEAN_NAME);
		...
		for (StopPoint item : addedStopPoint) {
			...
			if (stopPoint == null) {
				if (stopPoints == null) {
					stopPoints = stopPointDAO.findByObjectId(InserterUtils.getObjectIds(addedStopPoint));
		...
		for (VehicleJourney item : addedVehicleJourney) {
			...
			if (vehicleJourney == null) {
				if (vehicleJourneys == null) {
					vehicleJourneys = vehicleJourneyDAO.findByObjectId(InserterUtils.getObjectIds(addedVehicleJourney));
