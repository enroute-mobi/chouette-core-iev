...
@Log4j
public class OldProgressionCommand implements Command, Constant, ReportConstant {

	public static final String COMMAND = "OldProgressionCommand";
	...
	public static class DefaultCommandFactory extends CommandFactory {
		...
		private OldProgressionCommand instance;

		@Override
		protected Command create(InitialContext context) throws IOException {
			if (instance == null) {
				instance = new OldProgressionCommand();
			}
			return instance;
		}
	}
	...
	static {
		CommandFactory.factories.put(OldProgressionCommand.class.getName(), new DefaultCommandFactory());
	}
}
