...
public class FrameValidator extends AbstractValidator implements Constant{
	...
	/** 
 	 ...
 	 * <b>Message</b> : 
 	 * <ol>
 	 * <li>Le fichier commun.xml ne contient pas de frame nommée NETEX_COMMUN. </li>
 	 * <li>Le fichier commun.xml contient une frame nommée {nomFrame} non acceptée</li>
 	 * </ol>
 	 * <p>
 	 * <b>Criticité</b> :  error
 	 * <p>
	 ...
	 * <b>Titre</b> :[Netex] Organisation des frames du fichier calendriers.xml
 	 ...
 	 * <b>Message</b> : 
 	 * <ol>
 	 * <li>Le fichier calendriers.xml ne contient pas de frame nommée NETEX_CALENDRIER. </li>
 	 * <li>Le fichier calendriers.xml contient une frame nommée {nomFrame} non acceptée </li>
 	 * </ol>
 	 * <p>
 	 * <b>Criticité</b> :  error
 	 * <p>
	...
	private boolean check2NeTExStif2_2(Context context, String frameName, int lineNumber, int columnNumber) {
 	 ...
 	 * <b>Message</b> : 
 	 * <ol>
 	 * <li>Le fichier {nomFichier} ne contient pas de frame nommée NETEX_OFFRE_LIGNE. </li>
 	 * <li>Le fichier {nomFichier} contient une frame nommée {nomFrame} non acceptée. </li>
 	 * <li>la frame NETEX_OFFRE_LIGNE du fichier {nomFichier} ne contient pas la frame {NETEX_STRUCTURE/NETEX_HORAIRE} obligatoire. </li>
 	 * <li>la frame NETEX_OFFRE_LIGNE du fichier {nomFichier} contient une frame {nomFrame} non acceptée </li>
 	 * </ol>
 	 * <p>
 	 * <b>Criticité</b> :  error
 	 * <p>
