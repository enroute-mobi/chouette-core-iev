...
@Log4j
public class NetexStifParser implements Parser, Constant {
...
//				stopAreaParser.parse(context);
	...
	static {
		ParserFactory.register(NetexStifParser.class.getName(), new ParserFactory() {
			private NetexStifParser instance = new NetexStifParser();
