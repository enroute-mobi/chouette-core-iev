...
public class OperatingPeriodValidator extends AbstractValidator {
	...
	public boolean check2NeTExSTIFOperatingPeriod1(Context context, OperatingPeriod period, int lineNumber,
		...
		if (!result) {
			...
			validationReporter.addCheckPointReportError(context, null, NetexCheckPoints.L2_NeTExSTIF_OperatingPeriod_1,NetexCheckPoints.L2_NeTExSTIF_OperatingPeriod_1, location,sdf.format(period.getPeriod().getEndDate()),sdf.format(period.getPeriod().getStartDate()));
		}
		return result;
	}
