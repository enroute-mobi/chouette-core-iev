...
public interface Constant extends mobi.chouette.common.Constant {
	...
	public static final String PASSENGER_STOP_ASSIGNEMENTS = "passengerStopAssignments";
	public static final String PASSENGER_STOP_ASSIGNEMENT = "PassengerStopAssignment";
