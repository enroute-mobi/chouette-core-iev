...
@Log4j
public class GeneralFrameParser implements Parser {

	private static Map<String, String> frameTypes = new HashMap<>();

	static {
		frameTypes.put(NetexStifConstant.NETEX_STRUCTURE, NetexStructureParser.class.getName());
		frameTypes.put(NetexStifConstant.NETEX_HORAIRE, NetexHoraireParser.class.getName());
		frameTypes.put(NetexStifConstant.NETEX_COMMUN, NetexCommunParser.class.getName());
		frameTypes.put(NetexStifConstant.NETEX_CALENDRIER, NetexCalendrierParser.class.getName());
	...
	public void parse(Context context) throws Exception {
		...
		Collection<String> frames = (Collection<String>) context.get(NetexStifConstant.GENERAL_FRAMES);
